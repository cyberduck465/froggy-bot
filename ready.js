module.exports = async (client) => {
  ...
  const activities = [
    { name: 'f!help|awa', type: "STREAMING",
  ...
  setInterval(() => {
    activities[1] = { name: `f!help|${client.guilds.cache.size} 個伺服器`, type: "STREAMING",
  url: "https://www.twitch.tv/mini_ware"}; // Update server count
    activities[2] = { name: `f!help|由 Hello Phone 製作`, type: "STREAMING",
  url: "https://www.twitch.tv/mini_ware" }; // Update user count
